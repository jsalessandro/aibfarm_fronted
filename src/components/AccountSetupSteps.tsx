...
const AccountSetupSteps: React.FC = () => {
  ...
  const webSteps = [
    { image: '/account-setup-steps/web/1.jpg', title: '步骤 1', description: '设置账户模式' },
  ];

  const appSteps = [
    { image: '/account-setup-steps/app/1.jpg', title: '步骤 1', description: '打开应用设置' },
    { image: '/account-setup-steps/app/2.jpg', title: '步骤 2', description: '选择账户模式' },
    { image: '/account-setup-steps/app/3.jpg', title: '步骤 3', description: '完成设置' },
  ];
